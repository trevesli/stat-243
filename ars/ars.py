...
def is_log_concave(f, x_range, eps=1e-10):
    ...
    # Ensure no duplicates in range, so that it's strictly increasing
    ...
    # Ensure function values never drop below epsilon 
    ...
    # Ensures we are concave over the given range
